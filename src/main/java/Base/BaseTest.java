...
public class BaseTest {
	...
	public static AndroidDriver<AndroidElement> isdriver;
...
//		BasePage.source();
	...
	public static IOSDriver ioscapabilities() throws Exception{
		...
		ioscap.setCapability("wdaLocalPort", 8105);
		URL url = new URL("http://0.0.0.0:4722/");
	...
	public static void  safariurl() throws IOException, Exception {
...
//		cap.setCapability("newCommandTimeout", 90000);
		...
		isdriver = new AndroidDriver<AndroidElement>(url, cap);
