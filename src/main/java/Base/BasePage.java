...
//		String elementName = element.getAttribute("text");
	...
	public void clickE(IOSElement element, String elementName) {
		wLib.waitForElemnetToBeVisible( element);
	...
	public void sendKeys(IOSElement element, String txt) {
		wLib.waitForElemnetToBeVisible( element);
	...
	public void sendKeys(IOSElement element, String txt, String fieldName) {
		wLib.waitForElemnetToBeVisible( element);
		String name = element.getAttribute("name");
		if(name==null) {
			name=element.getAttribute("label");
	...
	public static boolean isDisplayed(IOSElement element) {
	...
	public void isDisplayedonscreen(IOSElement element) {
		String elementName = element.getAttribute("label");
		if(elementName==null) {
			elementName=element.getAttribute("name");
		}
	...
	public boolean isnotDisplayed(IOSElement element) {
		String elementName = element.getAttribute("label");
		if(elementName==null) {
			elementName=element.getAttribute("name");
		}
	...
	public void isnotDisplayedonscreen(IOSElement element, String elementName) {
		
			try {
				new WebDriverWait(BaseTest.driver, 10).until(ExpectedConditions.invisibilityOf(element));
...
//			element.click();
//		}
		public void scrollToelement(IOSElement element) {
		    try {
		...
		public void Scrolltoelement(IOSElement element, int scrollNumber, String elementName) throws InterruptedException {
try {
	//			AndroidDriver driver = BaseTest.driver;
	for (int i = 1; i < scrollNumber; i++) {
		try {
...
//public void scrollintoview(IOSElement driver, String scrollToText) {
...
//
//}
public void scrolluptillelement(IOSElement driver, String scrollToText) {
    try {
		...
		while (driver
				.findElements(MobileBy.AndroidUIAutomator("new UiSelector().textContains(\"" + scrollToText + "\")"))
				.size() == 0) {
...
public void clickToLeftOfText(String targetText) {
	try {
		IOSElement element = (IOSElement) driver.findElement(By.xpath("//*[contains(@text, '" + targetText + "')]"));
...
public void clickontext(String text, String elementName) {
	try {
		IOSElement element = (IOSElement) driver.findElement(By.xpath("//*[@text='" + text + "']"));
		wLib.waitForElemnetToBeVisible(element);
		element.click();
		BaseTest.test.info(elementName + " is clicked");
		LogManager.getLogger().info(elementName + " is clicked");
...
public void clickwaitios(IOSElement element,String elementName) {
	try {
...
public void clickvisble(IOSElement element,String elementName) {
	try {
		new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOf(element)).click();
		BaseTest.test.info(elementName + " is clicked");
		LogManager.getLogger().info(elementName + " is clicked");
	} catch (Exception e) {
...
public void waitelementtobeclickable(IOSElement element,String elementName) {
	try {
		new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(element)).isDisplayed();
...
//	}
public void taponelement(IOSElement element) {
	String elementName = element.getAttribute("label");
	if(elementName==null) {
		elementName=element.getAttribute("name");
	}
...
public void scrollup(IOSElement element) {
	try {
...
//public void scrollDown(IOSElement element) {
...
public void SlideOptions(IOSElement incident) throws InterruptedException {
	//open app 
...
private boolean isElementVisible(IOSElement element) {
    try {
...
public static void sendKeysOneByOne(IOSElement element, String text) {
...
public static String present(IOSElement element) {

	String present = Boolean.toString(isDisplayed(element));
	return present;
}
public void clicktext(String AidGiven) {
	IOSElement Aidselect = (IOSElement) driver.findElement(By.xpath("//XCUIElementTypeStaticText[@label='"+AidGiven+"']"));
	click(Aidselect);
}
public void clickontextcontains(String element) {
	IOSElement elementele = (IOSElement) driver.findElement(By.xpath("//*[contains(@name,'"+ element +"')]"));
	click(elementele);
}

public void dataclickbutton(String AidGiven) {
	IOSElement Aidselect = (IOSElement) driver.findElement(By.xpath("//XCUIElementTypeButton[@label='"+AidGiven+"']"));
	click(Aidselect);
}
...
public static String valuepresent(String elementtxt) {
	...
	IOSElement element = (IOSElement) driver.findElement(By.xpath("//XCUIElementTypeStaticText[@label='"+elementtxt+"']"));
...
public void checkgivendata(String datatxt) {
	IOSElement Checkelel = (IOSElement) driver.findElement(By.xpath("//*[contains(@value,'"+datatxt+"')]"));
